...
#
# The version lives in Resources/Info.plist. Both CFBundleShortVersionString and
# CFBundleVersion are kept in sync (this project does not use a separate build
# number). Merging the resulting PR into main triggers
# .github/workflows/release.yml, which tags v<version>, builds the .app, and
...
"${PLISTBUDDY}" -c "Set :CFBundleVersion ${NEW}" "${PLIST}"
